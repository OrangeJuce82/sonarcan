...
Stem mode is disabled by default. Startup verifies its disposable model cache
before the accelerator probe; after that probe succeeds, an Apple-silicon Mac starts
