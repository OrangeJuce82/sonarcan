...
export interface PracticeState {
  ...
  beatSubdivisionMode?: import("./beatHomogenization").BeatSubdivisionMode;
...
export type ImportProvider = "youtube" | "soundcloud" | "bandcamp" | "mixcloud" | "audiomack" | "beatport" | "hearthis.at" | "jamendo" | "reverbnation" | "web" | "local";
...
export interface ImportCandidate { input: string; title: string; detail: string; kind: "local" | "video" | "playlist" | "search"; matchScore?: number; thumbnailUrl?: string; videoId?: string; provider?: ImportProvider; sourceUrl?: string; blocked?: boolean; }
