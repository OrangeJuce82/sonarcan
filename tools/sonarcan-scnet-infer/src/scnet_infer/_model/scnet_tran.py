"""Faithful transformer SCNet architecture extracted from MSST.

Only the package-relative attention import differs from the referenced source.
Reads: scnet_infer._model.attention, rotary_embedding_torch.
"""
