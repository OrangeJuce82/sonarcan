"""Dual-path recurrent separation layers shared by SCNet variants.

The implementation is preserved from MSST to keep checkpoint compatibility.
Reads: torch recurrent and FFT primitives.
"""
